...
-- Commands
L["HELP"] = [=[开始物品的掷骰或竞骰（/PersoLootRoll or /plr）。
使用方法：
/plr: 开启选项视窗
...
L["OPT_ACTIONS_WINDOW_DESC"] = "有处理中的操作时显示操作窗口，例如，当你赢得一件物品但还需要交易某人才能得到它。"
...
L["OPT_MASTERLOOT_RULES_BID_PUBLIC_DESC"] = "你可以公开竞骰，这样每个人都可以看到谁掷骰。"
